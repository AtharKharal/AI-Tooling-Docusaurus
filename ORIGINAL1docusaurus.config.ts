...
const config: Config = {
  title: 'AI Tooling by Athar Kharal, PhD',
  ...
  organizationName: 'Aria Webworks, Finland', // Usually your GitHub org/user name.
  projectName: 'AI Tooling', // Usually your repo name.
